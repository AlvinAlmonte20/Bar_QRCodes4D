...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, TMSQRCode, Vcl.StdCtrls, Vcl.ExtCtrls;
...
begin
  ...
  PNGFileName := AppFolder + 'qrcode.png';
  SVGFileName := AppFolder + 'qrcode.svg';

  try
    FQRcode.SaveToPNG(PNGFileName);
    FQRcode.SaveToSVG(SVGFileName);
